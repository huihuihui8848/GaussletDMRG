...
def run_dmrg(npz_path, electrons=10):
...
if __name__ == '__main__':
    for Ls in ['01', '1', '3', '5', '10', '20']:
        ...
        for N in range(max_N):
            E_N, n_i = run_dmrg(f'data/L{Ls}_N51.npz', N)
            E[N] = E_N
